...
![MySQL](https://img.shields.io/badge/MySQL-%2300A98F.svg?style=for-the-badge&logo=mysql&logoColor=white)
...
🌐 Networking                 → TCP/IP • DNS • HTTP/HTTPS • Reverse Proxy
🔐 Security                   → DevSecOps • Cloud Security • Linux Security
⚡ Automation                 → Scripting • Infrastructure Automation
```
...
- ☸️ Deepening my **Kubernetes & container orchestration** knowledge
- 🏗️ Building more **Infrastructure-as-Code** driven environments
- 🔐 Integrating **security into CI/CD and cloud infrastructure**
- 📊 Improving **monitoring, observability & incident troubleshooting**
- ☁️ Expanding my experience across **AWS + Azure**
